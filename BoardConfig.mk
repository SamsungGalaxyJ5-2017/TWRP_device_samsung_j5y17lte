...
TARGET_PREBUILT_KERNEL := device/samsung/j5y17ltextc/Image
TARGET_PREBUILT_DTB := device/samsung/j5y17ltextc/dt.img

# Use this flag if the board has a ext4 partition larger than 2gb
BOARD_HAS_LARGE_FILESYSTEM := true
TARGET_USERIMAGES_USE_EXT4 := true
TARGET_USERIMAGES_USE_F2FS := true
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/j5y17ltextc/bootimg.mk
...
#TARGET_LIBINIT_DEFINES_FILE := device/samsung/j5y17ltextc/init/init_sec.cpp
